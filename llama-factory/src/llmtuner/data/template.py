...
# change the template complying with the SimPO: https://github.com/princeton-nlp/SimPO/blob/main/scripts/run_simpo.py
#   - no system prompt
_register_template(
    name="llama3-custom",
    format_user=StringFormatter(
...
# change the template following: https://huggingface.co/HuggingFaceH4/zephyr-7b-alpha/blob/2ce2d025864af849b3e5029e2ec9d568eeda892d/tokenizer_config.json#L34
_register_template(
    name="zephyr-custom",
